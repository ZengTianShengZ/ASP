...
import asp.com.asp.utils.NetWorkUtil;
...
/*    private static final Interceptor REWRITE_CACHE_CONTROL_INTERCEPTOR = new Interceptor() {
        ...
        public Response intercept(Interceptor.Chain chain) throws IOException {
            ...
            if (NetWorkUtil.isNetWorkAvailable(AspApplications.getInstance())) {
    ...
    private static File httpCacheDirectory = new File(AspApplications.getInstance().getCacheDir(), "zhihuCache");
